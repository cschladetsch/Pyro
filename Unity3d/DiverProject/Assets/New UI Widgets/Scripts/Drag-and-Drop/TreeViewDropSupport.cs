namespace UIWidgets
{
	...
	/// </summary>
	[AddComponentMenu("UI/UIWidgets/TreeView Drop Support")]
	...
	public class TreeViewDropSupport : TreeViewCustomDropSupport<TreeView, TreeViewComponent, TreeViewItem>, IDropSupport<ListViewIconsItemDescription>
	{
		...
		public void Drop(ListViewIconsItemDescription data, PointerEventData eventData)
		{
			...
			var newItem = new TreeViewItem(data.Name, data.Icon)
			{
				LocalizedName = data.LocalizedName,
				Value = data.Value,
			};
			var newNode = new TreeNode<TreeViewItem>(newItem, null, true, true);
