namespace UIWidgets
{
		...
		where TComponent : ListViewItem
	{
		...
		/// The components pool.
		/// </summary>
		protected ListViewComponentPool<TComponent, TItem> ComponentsPool = new ListViewComponentPool<TComponent, TItem>();
		...
		public override void Init()
		{
			...
			ComponentsPool.Owner = this;
			ComponentsPool.Container = Container;
			ComponentsPool.CallbackAdd = AddCallback;
			ComponentsPool.CallbackRemove = RemoveCallback;
		...
		/// <param name="unscaledTime">Use unscaled time.</param>
		protected virtual IEnumerator ScrollToAnimatedCoroutine(Vector2 targetPosition, bool unscaledTime)
		{
		...
		public override void ForEachComponent(Action<ListViewItem> func)
		{
			...
			ListRenderer.ForEachComponent(func);
		...
		{
			return DisplayedIndices.ToList();
		}
