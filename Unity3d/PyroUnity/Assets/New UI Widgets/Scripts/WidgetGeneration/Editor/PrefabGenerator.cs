...
namespace UIWidgets.WidgetGeneration
{
	...
	public abstract class PrefabGenerator
	{
		...
		/// <summary>
		/// Add listener to call specified method from target.
		/// </summary>
		/// <param name="listener">Listener.</param>
		/// <param name="target">Target.</param>
		/// <param name="methodName">Method name.</param>
		protected static void AddListener(UnityEvent listener, object target, string methodName)
		{
			var method = UnityEventBase.GetValidMethodInfo(target, methodName, Type.EmptyTypes);
			var method_delegate = Delegate.CreateDelegate(typeof(UnityAction), target, method) as UnityAction;
			UnityEventTools.AddPersistentListener(listener, method_delegate);
		}
